<template>
  <section id="about" class="type-primary grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-8 md:px-16 h-screen">
    ...
    <img
        data-aos="flip-right"
        data-aos-delay="200"
        class="order-1 md:order-2 mx-auto max-w-xs rounded-full overflow-hidden"
        :src="profileImage"
        alt="profile image"
    />
  </section>
