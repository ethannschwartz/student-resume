<template>
  <section id="experience" class="h-auto p-16 scroll-mt-8">
    <h4 data-aos="fade-up" class="font-bold type-secondary text-5xl mb-4">My Experience</h4>
    <ul class="gap-16 grid grid-cols-2">
